          ...
          <div className="p-6">
            ...
            <div className="flex gap-3">
              <a
                ...
                className="flex-1 text-center px-4 py-2.5 bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-lg text-sm font-medium hover:opacity-90 transition-opacity"
              >
